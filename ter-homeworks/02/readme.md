...
ошибка ` platform_id = "standart-v4" `  правильно platform_id = "standard-v3" опечатка в слове и неверная версия (допусттимы v1, v2,v3)
Накинул процов и core fraction для Vm для значения этой зоны
